...
export const aboutMe = 'I am a Front-End Engineer with 5 years of experience in software development. After a brief sabbatical to evaluate, experiment, and re-energize, I am seeking an opportunity where I can exercise my skills in UI/UX, leadership, and technology. I’ve held roles in a variety of industries, and with my background in development and an eye towards the future, I bring an innovative perspective framed with technical possibility to business and product analysis.'
export const aboutMe1 = 'I am a Front-End Engineer with 5 years of experience in software development. '
export const aboutMe2 = 'I am seeking an opportunity where I can exercise my skills in UI/UX, leadership, and technology. '
export const aboutMe3 = 'I’ve held roles in a variety of industries, and with my background in development and an eye towards the future, I bring an innovative perspective framed with technical possibility to business and product analysis.'
export const email = "kate@thekatebishop.com"
export const location = "Atlanta, GA"
export const linkedin = "https://www.linkedin.com/in/thekateperry/"
export const linkedinShort = "linkedin.com/in/thekateperry"
export const github = "https://github.com/kate-perry"
export const githubShort = "github.com/kate-perry"
export const languages = "JavaScript (React, Next.js, Node.js), GraphQL, Python, C#, Java, SQL, HTML/CSS"
export const technologies = "Visual Studio, Xamarin, Tableau, MS SQL, MongoDB, Postgres, AWS, Azure, Lucidchart, Sketch, Balsamiq, Figma, Agile, Scrum, Design Think"
...
export const experience = [
    {
        ...
        companyDescription: 'Manufactured is a venture-backed product sourcing company that provides entrepreneurs with access to manufacturing companies.',
        description: 'I led front-end product development with React and GraphQL for a team of 4 to bring a green-field platform to launch. Along with development and delivery, my responsibilities extended to plan and scope up to 3 work streams at a time.',
        keyProjects: [
            {
                projectName: null,
                projectRole: null,
    ...
    },
    {
        ...
        companyDescription: 'Groundspeed Analytics is an artificial intelligence InsurTech startup revolutionizing the $350 billion commercial insurance industry.',
        description: 'I implemented new features while improving existing software to prepare for major customer scaling.',
        keyProjects: [
            {
    ...
    },
    {
        ...
        description: 'Explored modes of communication with students to initiate difficult conversations about academic performance.',
        keyProjects: [
            {
                projectName: null,
                projectRole: null,
