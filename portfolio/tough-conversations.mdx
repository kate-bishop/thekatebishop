...
a scatter plot of majors mapped on scales of academic and interest fit. This tool can help answer the *What*.

![A simplified recreation of the Major Map](public/images/tc-major-map.png)

#### College Recommender

a generator to rank colleges whose student body’s ACT assessment scores are comparable to those of the user. This tool can help answer the *Where*.
...
This tool can help give clarity on the *How*.
