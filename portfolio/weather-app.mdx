...
image: {
  src: "/images/portfolio/wa-final.png"
}
---
...
[Weather Forecast App (Hosted with Netlify)](https://delightful-cascaron-24b3b4.netlify.app)

[GitHub Repository](https://github.com/kate-bishop/weather-forecast-app)
...
![Screenshot of design overlaid with Feature Groupings analysis](/images/portfolio/wa-feature-group.png)
...
![Screenshot of the final Forecast App](/images/portfolio/wa-final.png)

View app on [Netlify](https://delightful-cascaron-24b3b4.netlify.app).

View code repository on [GitHub](https://github.com/kate-bishop/weather-forecast-app).
